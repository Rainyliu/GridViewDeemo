 ...
 * Since: 2016/9/26 0026 上午 10:26 <br>
 */
...
public class CustomWebView extends WebView implements View.OnLongClickListener{
    ...
    private void initSettings() {
        ...
        mSettings.setUseWideViewPort(true);//调整适合webview大小
        mSettings.setLoadWithOverviewMode(true);//调整到适合webview大小
        mSettings.setDefaultZoom(WebSettings.ZoomDensity.FAR);//屏幕自适应网页，如果没有这个，在低分别率的手机上显示可能会异常
